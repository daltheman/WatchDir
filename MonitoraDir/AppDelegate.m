...
void file_events_callback(ConstFSEventStreamRef streamRef,
                       void *userData,
                       size_t numEvents,
                       void *eventPaths,
    ...
    for (int  i = 0; i < numEvents; i++) {
        ...
        NSLog(@"num events: %zi, %llu, %02x, %@", numEvents,eventIds[i], flags, [NSString stringWithUTF8String:paths[i]]);
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
    ...
    streamRef = FSEventStreamCreate(NULL, &file_events_callback, streamContext, pathsToWatch, kFSEventStreamEventIdSinceNow, 1.0, kFSEventStreamEventFlagNone);
